...
public class APIupdateVipStoreRuleDetailTest extends APITest{
	  @Test
	  public void updateVipStoreRuleDetailTest() throws Exception {
		  
		  boolean apiResult=true;
			String[][] testMap=ReadExcelCase.getTestMap("/vipSettingWS/updateVipStoreRuleDetail");
