...
public class APIqueryVipTypeListTest extends APITest{
	  @Test
	  public void queryVipTypeListTest() throws Exception {
		  
		  boolean apiResult=true;
			String[][] testMap=ReadExcelCase.getTestMap("/vipSettingWS/queryVipTypeList");
