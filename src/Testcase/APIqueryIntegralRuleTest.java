...
public class APIqueryIntegralRuleTest extends APITest{
	  @Test
	  public void queryIntegralRuleTest() throws Exception {
		  
		  boolean apiResult=true;
			String[][] testMap=ReadExcelCase.getTestMap("/vipSettingWS/queryIntegralRule");
