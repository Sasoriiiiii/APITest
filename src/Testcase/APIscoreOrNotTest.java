...
public class APIscoreOrNotTest extends APITest{
	@Test
	public void scoreOrNotTest() throws Exception {

		boolean apiResult = true;
		String[][] testMap = ReadExcelCase.getTestMap("/baseWS/scoreOrNot");
			...
			try {
				...
				db1.pst = db1.conn.prepareStatement(
						"insert into payment (id,payment_code,payment_name,payment_status,currency_id,is_deleted,tenant_id,branch_id,payment_type,is_score)"
								+ "values(8000,'CSH','现金',0,1,0,243,13892,1,0)");
				db1.pst.executeUpdate();
				db1.pst = db1.conn.prepareStatement(
				...
				db1.pst = db1.conn.prepareStatement(
						"insert into payment (id,payment_code,payment_name,payment_status,currency_id,is_deleted,tenant_id,branch_id,payment_type,is_score)"
								+ "values(8007,'ZDY_0001','zf1',0,1,0,243,13892,1,0)");
				db1.pst.executeUpdate();
				db1.pst = db1.conn.prepareStatement(
						"insert into payment (id,payment_code,payment_name,payment_status,currency_id,is_deleted,tenant_id,branch_id,payment_type)"
				...
				db1.pst = db1.conn.prepareStatement(
						"insert into payment (id,payment_code,payment_name,payment_status,currency_id,is_deleted,tenant_id,branch_id,payment_type,is_score)"
								+ "values(8009,'ZDY_0001','zf2',0,1,0,243,13892,1,1)");
				db1.pst.executeUpdate();
				db1.pst = db1.conn.prepareStatement(
						"insert into payment (id,payment_code,payment_name,payment_status,currency_id,is_deleted,tenant_id,branch_id,payment_type,is_score)"
								+ "values(8010,'ZDY_0001','zf3',1,1,0,243,13892,1,0)");
				db1.pst.executeUpdate();
				db1.close();
