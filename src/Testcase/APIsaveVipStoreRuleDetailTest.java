...
public class APIsaveVipStoreRuleDetailTest extends APITest{
	  @Test
	  public void saveVipStoreRuleDetailTest() throws Exception {
		  
		  boolean apiResult=true;
			String[][] testMap=ReadExcelCase.getTestMap("/vipSettingWS/saveVipStoreRuleDetail");
