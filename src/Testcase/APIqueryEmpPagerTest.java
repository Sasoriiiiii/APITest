...
public class APIqueryEmpPagerTest extends APITest{
	  @Test
	  public void queryEmpPagerTest() throws Exception {
		  
		  boolean apiResult=true;
			String[][] testMap=ReadExcelCase.getTestMap("/baseWS/queryEmpPager");
			for(int i=0;i<testMap.length;i++){
				  ...
				  try {
					  ...
					  db1.pst = db1.conn.prepareStatement(
						"insert into s_user (id,login_name,login_pass,user_type,state,name,is_deleted,tenant_id)"
								+ "values(80002,'0002:61011098','21218cca77804d2ba1922c33e0151105',3,1,123,0,243)");
					  db1.pst.executeUpdate();
				  ...
				  try {
					  ...
					  db2.pst.executeUpdate();
					  db2.pst=db2.conn.prepareStatement("insert into employee (id,tenant_id,branch_id,user_id,login_name,code,name,password_for_local,is_deleted,state)"
					  		+ "values(1001,243,13892,80001,'0001:61011098','0001',123,'21218cca77804d2ba1922c33e0151105',0,1)");
					  db2.pst.executeUpdate();
					  db2.pst = db2.conn.prepareStatement(
						"insert into employee (id,tenant_id,branch_id,user_id,login_name,code,name,password_for_local,is_deleted,state)"
								+ "values(1002,243,13892,80002,'0002:61011098','0002',123,'21218cca77804d2ba1922c33e0151105',0,2)");
					  db2.pst.executeUpdate();
					  db2.pst = db2.conn.prepareStatement(
						"insert into employee (id,tenant_id,branch_id,user_id,login_name,code,name,password_for_local,is_deleted,state)"
								+ "values(1003,243,13892,80003,'0003:61011098','0003',123,'21218cca77804d2ba1922c33e0151105',1,1)");
					  db2.pst.executeUpdate();
