...
public class APIqueryVipStoreRuleTest extends APITest{
	  @Test
	  public void queryVipStoreRuleTest() throws Exception {
		  
		  boolean apiResult=true;
			String[][] testMap=ReadExcelCase.getTestMap("/vipSettingWS/queryVipStoreRule");
			for(int i=0;i<testMap.length;i++){
				  ...
				  try {
					  ...
					  db1.pst.executeUpdate();
					  db1.pst=db1.conn.prepareStatement("insert into vip_store_rule_details (id,rule_id,pay_limit,present_limit,is_deleted)values(8002,102,100,1,0)");
					  db1.pst.executeUpdate();
