...
public class APIdeletePaymentsTest extends APITest{
	@Test
	public void deletePaymentsTest() throws Exception {

		boolean apiResult = true;
		String[][] testMap = ReadExcelCase.getTestMap("/baseWS/deletePayments");
