...
public class APIqueryCatListTest extends APITest{
  @Test
  public void queryCatListTest() throws IOException {
	  
		boolean apiResult=true;
		String[][] testMap=ReadExcelCase.getTestMap("/baseWS/queryCatList");
