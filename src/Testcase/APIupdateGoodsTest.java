...
public class APIupdateGoodsTest extends APITest{
  @Test
	public void updateGoodsTest() throws IOException {
	  
	boolean apiResult=true;
	String[][] testMap=ReadExcelCase.getTestMap("/baseWS/updateGoods");
	for(int i=0;i<testMap.length;i++){
		  ...
		  try {
			...
			db1.pst.executeUpdate();
			db1.pst=db1.conn.prepareStatement("insert into goods_unit (`id`,`unit_code`,`unit_name`,`tenant_id`)VALUES('8001','001','单位1','243')");
			db1.pst.executeUpdate();
			db1.pst=db1.conn.prepareStatement("insert into goods_unit (`id`,`unit_code`,`unit_name`,`tenant_id`)VALUES('8002','002','单位2','243')");
			db1.pst.executeUpdate();
