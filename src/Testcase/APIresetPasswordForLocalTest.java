...
public class APIresetPasswordForLocalTest extends APITest{
	  @Test
	  public void resetPasswordForLocalTest() throws Exception {
		  
		  boolean apiResult=true;
			String[][] testMap=ReadExcelCase.getTestMap("/baseWS/resetPasswordForLocal");
				 ...
				 DBHelper db1=new DBHelper("saas");
				  try {
					  ...
					  db1.pst = db1.conn.prepareStatement(
						"insert into s_user (id,login_name,login_pass,user_type,state,name,is_deleted,tenant_id)"
								+ "values(80001,'0001:61011098','e10adc3949ba59abbe56e057f20f883e',3,1,123,0,243)");
					  db1.pst.executeUpdate();
					  db1.pst = db1.conn.prepareStatement("insert into s_user_role_r (user_id,role_id)values(80001,959)");
					  db1.pst.executeUpdate();
					  db1.pst = db1.conn.prepareStatement(
						"insert into s_user (id,login_name,login_pass,user_type,state,name,is_deleted,tenant_id)"
								+ "values(80002,'0002:61011098','e10adc3949ba59abbe56e057f20f883e',3,2,123,0,243)");
					  db1.pst.executeUpdate();
					  db1.pst = db1.conn.prepareStatement("insert into s_user_role_r (user_id,role_id)values(80002,959)");
					  db1.pst.executeUpdate();
					  db1.pst = db1.conn.prepareStatement(
						"insert into s_user (id,login_name,login_pass,user_type,state,name,is_deleted,tenant_id)"
								+ "values(80003,'0003:61011098','e10adc3949ba59abbe56e057f20f883e',3,1,123,1,243)");
					  db1.pst.executeUpdate();
				  ...
				  try {
					  ...
					  db2.pst=db2.conn.prepareStatement("insert into employee (id,tenant_id,branch_id,user_id,login_name,code,name,password_for_local,is_deleted)"
						  		+ "values(1000,243,13892,80000,'61011098','0000',123,'e10adc3949ba59abbe56e057f20f883e',0)");
					  db2.pst.executeUpdate();
					  db2.pst=db2.conn.prepareStatement("insert into employee (id,tenant_id,branch_id,user_id,login_name,code,name,password_for_local,is_deleted)"
					  		+ "values(1001,243,13892,80001,'0001:61011098','0001',123,'e10adc3949ba59abbe56e057f20f883e',0)");
					  db2.pst.executeUpdate();
					  db2.pst = db2.conn.prepareStatement(
						"insert into employee (id,tenant_id,branch_id,user_id,login_name,code,name,password_for_local,is_deleted)"
								+ "values(1002,243,13892,80002,'0002:61011098','0002',123,'e10adc3949ba59abbe56e057f20f883e',0)");
					  db2.pst.executeUpdate();
					  db2.pst = db2.conn.prepareStatement(
						"insert into employee (id,tenant_id,branch_id,user_id,login_name,code,name,password_for_local,is_deleted)"
								+ "values(1003,243,13892,80003,'0003:61011098','0003',123,'e10adc3949ba59abbe56e057f20f883e',1)");
					  db2.pst.executeUpdate();
